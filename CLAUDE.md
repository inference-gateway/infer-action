...
There is no unit test suite — validation is exclusively `act` against the JSON fixtures in `.github/workflows/events/`. Update those fixtures when changing trigger parsing or event-specific logic.
