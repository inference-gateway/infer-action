...
- **Comment-ID threading** — `cooking_comment_id` is the join key between the early "I'm cooking" post and every subsequent agent update. Changing how/when that comment is created requires updating the system prompt that references it.
