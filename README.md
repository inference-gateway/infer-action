...
| `otel-exporter-otlp-protocol` | OTLP transport protocol. Defaults to `http/protobuf`. Also accepts `http/json`. gRPC not supported in MVP. Maps to `OTEL_EXPORTER_OTLP_PROTOCOL`.                                                                                                                                                                           | No       | `http/protobuf` |
